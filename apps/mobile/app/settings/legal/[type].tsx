...
const CONTENT: Record<LegalType, { title: string; updatedAt: string; sections: { h: string; b: string }[] }> = {
  terms: {
    ...
    sections: [
      { h: '제1조 (목적)',
        b: '본 약관은 더블원플러스(이하 "회사")이 제공하는 캐시백 및 부가 서비스(이하 "서비스") 이용과 관련하여 회사와 회원 간의 권리, 의무 및 책임 사항을 규정함을 목적으로 합니다.' },
      { h: '제2조 (용어의 정의)',
  ...
  privacy: {
    ...
    sections: [
      ...
      { h: '7. 개인정보 보호책임자',
        b: '개인정보 처리에 관한 문의·민원은 더블원플러스 고객센터를 통해 접수해 주시기 바랍니다. 회사는 신속히 답변드리겠습니다.' },
      { h: '8. 처리방침의 변경',
